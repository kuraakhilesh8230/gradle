...
class DefaultScalaSourceSetTest {
    ...
    private final DefaultScalaSourceSet sourceSet = new DefaultScalaSourceSet("<set-display-name>", TestUtil.objectFactory(tmpDir.testDirectory), TestFiles.getPatternSetFactory(), TestFiles.fileCollectionFactory(tmpDir.file()), TestFiles.directoryFileTreeFactory())
